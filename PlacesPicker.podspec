#
#  Be sure to run `pod spec lint GooglePlacesPicker.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Piotr Bernad" => "piotr@bernad.co" }
  # Or just: spec.author    = "Piotr Bernad"
  # spec.authors            = { "Piotr Bernad" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Piotr Bernad"
  ...
  spec.source       = { :git => "https://github.com/piotrbernad/GooglePlacesPicker.git", :tag => "#{spec.version}" }
